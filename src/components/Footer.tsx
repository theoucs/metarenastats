...
export function Footer() {
  return (
    <footer className="border-t border-zinc-800/80 px-4 py-6 text-center text-xs text-zinc-600 sm:px-6">
      ...
      <p className="mt-2">
        <Link href="/privacy" className="hover:text-zinc-400 hover:underline">
